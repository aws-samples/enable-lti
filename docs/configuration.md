...
2. Select “Developer Keys“ - _URL should be simliar to [https://XXXX/accounts/X/developer_keys]_
...
3. Add identity provider details:
   ...
   6. Manual input
      1. Issuer URL: _Since using Canvas in example_, Enter [https://canvas.instructure.com](https://canvas.instructure.com/)
      ...
      5. Jwks*uri endpoint: \_Since using Canvas in example*, Enter https://sso.canvaslms.com/api/lti/security/jwks
